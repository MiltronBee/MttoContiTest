    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetUserDetail(int id)
        {
            ...
            var user = new UserDetailDto
            {
                ...
                FechaIngreso = baseUser.FechaIngreso.HasValue ? baseUser.FechaIngreso.Value.ToDateTime(TimeOnly.MinValue) : (DateTime?)null,
        ...
        public IActionResult GetCurrentUserProfile()
        {
            ...
            var profile = new UserProfileDto
            {
                ...
                Antiguedad = user.FechaIngreso.HasValue ? (float?)((DateTime.UtcNow - user.FechaIngreso.Value.ToDateTime(TimeOnly.MinValue)).TotalDays / 365) : null
            };
