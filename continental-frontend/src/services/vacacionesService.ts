...
import type { ApiResponse, VacacionesAsignadasResponse, VacacionesAsignadasCompleteResponse, DisponibilidadVacacionesResponse, ReservaAnualRequest, ReservaAnualResponse, AsignacionManualRequest, AsignacionManualResponse } from '@/interfaces/Api.interface';
...
export const vacacionesService = {
  ...
  async getVacacionesAsignadas(params: {
    empleadoId?: number;
    areaId?: number;
    grupoId?: number;
    anio?: number;
